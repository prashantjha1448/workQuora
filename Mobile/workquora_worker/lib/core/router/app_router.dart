...
import '../../features/discover/presentation/screens/jobs_discover_screen.dart';
...
import '../../features/profile_kyc/presentation/screens/skills_editor_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      // /terms, /skills, /gig are reachable when authenticated — no bounce.
    ...
    routes: [
      ...
      GoRoute(path: '/skills', builder: (_, __) => const SkillsEditorScreen()),
      GoRoute(
        path: '/gig/:id',
        builder: (_, state) => Scaffold(
          appBar: AppBar(title: const Text('Gig Details')),
          body: Center(child: Text('Gig ${state.pathParameters['id']} — details coming soon')),
        ),
      ),
      ...
      StatefulShellRoute.indexedStack(
        ...
        branches: [
          ...
          StatefulShellBranch(routes: [
            GoRoute(
              path: '/discover',
              builder: (_, __) => const JobsDiscoverScreen(),
              routes: [
                GoRoute(
                  path: ':userId',
          ...
          StatefulShellBranch(routes: [
            GoRoute(
              ...
              builder: (_, __) => Scaffold(
                ...
                body: const Center(child: Text('Your accepted gigs appear here.')),
              ),
            ),
          ]),
          StatefulShellBranch(routes: [
            GoRoute(path: '/wallet-tab', builder: (_, __) => const WalletScreen()),
          ]),
          StatefulShellBranch(routes: [
            GoRoute(
              path: '/messages',
